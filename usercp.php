...
function usercpmenu ($selected = "home") {
	global $lang_usercp;
	begin_main_frame();
	print ("<div id=\"usercpnav\"><ul id=\"usercpmenu\" class=\"nav nav-tabs\" role=\"teblist\">");
	print ("<li" . ($selected == "home" ? " class=active" : "") . "><a href=\"usercp.php\">".$lang_usercp['text_user_cp_home']."</a></li>");
	print ("<li" . ($selected == "personal" ? " class=active" : "") . "><a href=\"?action=personal\">".$lang_usercp['text_personal_settings']."</a></li>");
	print ("<li" . ($selected == "tracker" ? " class=active" : "") . "><a href=\"?action=tracker\">".$lang_usercp['text_tracker_settings']."</a></li>");
	print ("<li" . ($selected == "forum" ? " class=active" : "") . "><a href=\"?action=forum\">".$lang_usercp['text_forum_settings']."</a></li>");
	print ("<li" . ($selected == "security" ? " class=active" : "") . "><a href=\"?action=security\">".$lang_usercp['text_security_settings']."</a></li>");
	print ("</ul></div>");
	end_main_frame();
}
...
<?php
print("<div class=\"panel-heading\"><h3 class=\"panel-title\">".$lang_usercp['text_recently_read_topics']."</h3></div>");
?>
<?php
print("<table class=\"table\"><tr>".
"<td class=colhead align=left width=60%>".$lang_usercp['col_topic_title']."</td>".
"<td class=colhead align=center><nobr>".$lang_usercp['col_replies']."/".$lang_usercp['col_views']."</nobr></td>".
"<td class=colhead align=center width=15%>".$lang_usercp['col_topic_starter']."</td>".
"<td class=colhead align=center width=15%>".$lang_usercp['col_last_post']."</td>".
"</tr>");
