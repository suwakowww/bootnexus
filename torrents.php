...
?>
<div class="col-md-4">
<form method="get" class="form-horizontal" name="searchbox" action="?">
...
<div class="panel-heading"><h2 class="panel-title"><a data-toggle="collapse" href="#ksearchboxmain" aria-expanded="true" aria-controls="ksearchboxmain"><?php echo $lang_torrents['text_search_box'] ?></a></h2></div>
		...
		<div class="panel=body">
			...
			?>
							...
							<label for="included" class="col-sm-5 control-label"><?php echo $lang_torrents['text_show_dead_active'] ?></label>
							<div class="col-sm-7"><select class="form-control" name="incldead" id="included">
							...
							<div class="form-group">
							<label for="spstate" class="col-sm-5 control-label"><?php echo $lang_torrents['text_show_special_torrents'] ?></label>
							<div class="col-sm-7"><select class="form-control" name="spstate" id="spstate">
...
<?php echo promotion_selection($special_state, 0)?>
						...
						<div class="form-group">
						<label for="inclbookmarked" class="col-sm-5 control-label"><?php echo $lang_torrents['text_show_bookmarked'] ?></label>
						<div class="col-sm-7">
							<select class="form-control" name="inclbookmarked" id="inclbookmarked">
								<option value="0"><?php echo $lang_torrents['select_all'] ?></option>
		...
		<div class="panel-footer">
							<div class="form-group">
							<label for="searchinput" class="col-sm-4 control-label"><?php echo $lang_torrents['text_search'] ?></label>
							<div class="col-sm-8">
										<input class="form-control" id="searchinput" name="search" type="text" value="<?php echo  $searchstr_ori ?>" autocomplete="off" ondblclick="suggest(event.keyCode,this.value);" onkeyup="suggest(event.keyCode,this.value);" onkeypress="return noenter(event.keyCode);"/>
							...
							<div class="form-group">
							<label for="search_area" class="col-sm-4 control-label"><?php echo "&nbsp;" . $lang_torrents['text_in'] ?></label>
							<div class="col-sm-8">
							...
							<div class="form-group">
							<label for="search_mode" class="col-sm-4 control-label"><?php echo $lang_torrents['text_with'] ?></label>
							<div class="col-sm-8">
