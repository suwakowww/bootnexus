...
// ------------- start: recent news ------------------//
print("<div class=\"col-sm-8\"><h2>".$lang_index['text_recent_news'].(get_user_class() >= $newsmanage_class ? " - <font class=\"small\">[<a class=\"altlink\" href=\"news.php\"><b>".$lang_index['text_news_page']."</b></a>]</font>" : "")."</h2>");
...
//check whether current user has voted
	...
	print("<div class=\"embed-responsive embed-responsive-16by9\"><iframe class=\"embed-responsive-item\" src=\"fun.php?action=view\" frameborder='0' name='funbox' marginwidth='0' marginheight='0'></iframe></div>");
...
<?php
	print("<div class=\"well\">");
	print("<div class=\"embed-responsive embed-responsive-16by9\"><iframe class=\"embed-responsive-item\" src='shoutbox.php?type=shoutbox' frameborder='0' name='sbox' marginwidth='0' marginheight='0'></iframe></div>");
	print("<form class=\"form-inline\" role=\"form\" action='shoutbox.php' method='get' target='sbox' name='shbox'>");
	print("<p class=\"form-control-static\" for='shbox_text'>".$lang_index['text_message']."</p><input class=\"form-control\" style=\"width:70%;\" type='text' name='shbox_text' id='shbox_text' placeholder=\"在这里输入......\" />  <input type='submit' id='hbsubmit' class='btn btn-success' name='shout' value=\"".$lang_index['sumbit_shout']."\" />");
	if ($CURUSER['hidehb'] != 'yes' && $showhelpbox_main =='yes')
		print("<input type='submit' class='btn btn-success' name='toguest' value=\"".$lang_index['sumbit_to_guest']."\" />");
	print("&nbsp;<input type='reset' class='btn btn-info' value=\"".$lang_index['submit_clear']."\" /> <input type='hidden' name='sent' value='yes' /><input type='hidden' name='type' value='shoutbox' /><br />\n");
...
<div class="panel-heading"><h2 class="panel-title"><?php echo $lang_index['text_tracker_statistics'] ?></h2></div>
<table class="table">
<?php
...
<div class="panel-heading"><h2 class="panel-title"><?php echo $lang_index['text_tracker_load'] ?></h2></div>
<?php
	//uptime, work in *nix system
	print ("<div class=\"panel-body\">" . trim($uptimeresult) . "</div>");
	print("</div>");
	}
}
// ------------- end: tracker load ------------------//
...
<div class="panel-heading"><h2 class="panel-title"><?php echo $lang_index['text_disclaimer'] ?></h2></div>
...
// ------------- end: disclaimer ------------------//
// ------------- start: links ------------------//
	print("<div class=\"panel-heading\"><h2 class=\"panel-title\">".$lang_index['text_links']."</h2></div><div class=\"panel-body\">");
...
<?php echo $lang_index['text_browser_note'] ?></div>
